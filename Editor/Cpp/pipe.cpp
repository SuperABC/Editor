...
bool Pipe::RunProcess(const std::string &process) {
...
bool Pipe::GetOutput(const std::string &endStr, int timeout, std::string &outstr) {
...
bool Pipe::SetInput(const std::string &cmd) {
